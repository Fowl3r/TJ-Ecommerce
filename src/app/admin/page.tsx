...
export default async function AdminDashboard() {
    //get them in parallel more performant 
	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <DashboardCard title="Active Products" subtitle={`${formatNumber(productData.inactiveCount)} Average Value`} body={formatNumber(productData.activeCount)} />
        </div>
	);
}
